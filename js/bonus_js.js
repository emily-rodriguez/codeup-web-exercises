...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/U037MJFLX/F9XUVCQMT/bonus_js.js?nojsmode=1" /></noscript>
...
(function() {
	...
	<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/webpack.manifest.4a80637cad8d1b6f789c.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<script type="text/javascript">
		...
		sb('set', 'token', '3307f436963e02d4f9eb85ce5159744c');
					...
					sb('set', 'user_id', "U9JGVMMQT");
							sb('set', 'user_' + "batch", "immediate-launch");
							sb('set', 'user_' + "created", "2018-03-05");
						sb('set', 'name_tag', "codeup" + '/' + "emily.m.b.rodriguez");
				sb('track', 'pageview');
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
		...
		window.addEventListener('load', function() {
	        ...
	        <title>bonus.js | Codeup Slack</title>
	...
	<div id="site_nav_contents">
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://avatars.slack-edge.com/2018-03-06/326442895894_5fea34ed3b92ee893d1f_192.jpg')" data-thumb-size="48" data-member-id="U9JGVMMQT"></span>
					<span class="member_image thumb_36" style="background-image: url('https://avatars.slack-edge.com/2018-03-06/326442895894_5fea34ed3b92ee893d1f_72.jpg')" data-thumb-size="36" data-member-id="U9JGVMMQT"></span>
				</div>
				<h3>Signed in as</h3>
				<span id="user_menu_name">Emily Rodriguez</span>
			</div>
		</div>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/2317866748?crumb=s-1522269331-dbc0639847816700581b122f8798a6b3cd9f9b2f8e8d86a08f5e690fb3d94f6a-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<li class="active">
	<a href="https://codeup.slack.com/home" target="https://codeup.slack.com/">
					<i class="ts_icon small ts_icon_check_circle_o active_icon s"></i>
							<i class="team_icon small" style="background-image: url('https://slack-files2.s3-us-west-2.amazonaws.com/avatars/2017-10-17/258750327111_60e57be4e0bf9c1e5c1d_88.png');"></i>
				<span class="switcher_label team_name">Codeup</span>
	</a>
</li>													
<li >
	<a href="https://geekdomsa.slack.com/home" target="https://geekdomsa.slack.com/">
							<i class="team_icon small" style="background-image: url('https://slack-files2.s3-us-west-2.amazonaws.com/avatars/2014-12-04/3148202344_2e0573a69e3088fe6bf2_88.jpg');"></i>
...
<p class="print_only">
	...
	Created by ryanorsinger on Wednesday, March 28, 2018 at 3:34 PM
	</strong><br />
	<span class="subtle_silver break_word">https://codeup.slack.com/files/U037MJFLX/F9XUVCQMT/bonus_js.js</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T029BRGN0-F9XUVCQMT-277961e832" target="new">https://slack-files.com/T029BRGN0-F9XUVCQMT-277961e832</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		234b JavaScript/JSON snippet created on <span class="date">March 28, 2018</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">// sum up all the expenses
...
var expenses = [
	...
	<form action="https://codeup.slack.com/files/U037MJFLX/F9XUVCQMT/bonus_js.js"
			id="file_comment_form"
							class="comment_form clearfix"
						method="post">
					<a href="/team/U9JGVMMQT" class="member_preview_link" data-member-id="U9JGVMMQT" >
				<span class="member_image thumb_36" style="background-image: url('https://avatars.slack-edge.com/2018-03-06/326442895894_5fea34ed3b92ee893d1f_72.jpg')" data-thumb-size="36" data-member-id="U9JGVMMQT"></span>
			</a>
				<input type="hidden" name="addcomment" value="1" />
		<input type="hidden" name="crumb" value="s-1522269331-19c9e4d33559eac84a5f6d07ee9fb3cbeb7475f8004a26c06af33e0c71372ee1-☃" />
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U9JGVMMQT',
		team_id: 'T029BRGN0',
		visitor_uid: ".3pnvwbeyluio4c044cg8ckcg8",
		no_login: false,
		version_ts: "1522268892",
		version_uid: "e3a5d087ec810ee6227c82918b4a9e506fa0c2bf",
		cache_version: "v17-vulture",
		...
		clog_url: "clog\/track\/",
		api_token: "xoxs-2317866748-324573735843-324573746771-60125097c7",
		ls_disabled: false,
		hc_tracking_qs: "sid=zd-uf-t029brgn0-u9jgvmmqt",
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_required_libs.f9713d5aad29a12554b7.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/application.8b0113aff66b8af90039.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-core_web.a85b39d79e64ec97e665.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/rollup-secondary_a_required.b8ab25469c1a89f06672.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/bv1-1/codemirror_load.ca4f26b018edcede90ce.min.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F9XUVCQMT","created":1522269298,"timestamp":1522269298,"name":"bonus_js.js","title":"bonus.js","mimetype":"text\/plain","filetype":"javascript","pretty_type":"JavaScript\/JSON","user":"U037MJFLX","editable":true,"size":234,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T029BRGN0-F9XUVCQMT\/bonus_js.js","url_private_download":"https:\/\/files.slack.com\/files-pri\/T029BRGN0-F9XUVCQMT\/download\/bonus_js.js","permalink":"https:\/\/codeup.slack.com\/files\/U037MJFLX\/F9XUVCQMT\/bonus_js.js","permalink_public":"https:\/\/slack-files.com\/T029BRGN0-F9XUVCQMT-277961e832","edit_link":"https:\/\/codeup.slack.com\/files\/U037MJFLX\/F9XUVCQMT\/bonus_js.js\/edit","preview":"\/\/ sum up all the expenses\r\n\/\/ get an average of all the expenses\r\nvar expenses = [\r\n    {itemName: \"macbook pro\", cost: \"$2,400\"},\r\n    {itemName: \"raspberry pi\", cost: \"$60\"},\r","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E\/\/ sum up all the expenses\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E\/\/ get an average of all the expenses\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Evar\u003C\/span\u003E \u003Cspan class=\"cm-def\"\u003Eexpenses\u003C\/span\u003E \u003Cspan class=\"cm-operator\"\u003E=\u003C\/span\u003E [\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E    {\u003Cspan class=\"cm-property\"\u003EitemName\u003C\/span\u003E: \u003Cspan class=\"cm-string\"\u003E&quot;macbook pro&quot;\u003C\/span\u003E, \u003Cspan class=\"cm-property\"\u003Ecost\u003C\/span\u003E: \u003Cspan class=\"cm-string\"\u003E&quot;$2,400&quot;\u003C\/span\u003E},\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E    {\u003Cspan class=\"cm-property\"\u003EitemName\u003C\/span\u003E: \u003Cspan class=\"cm-string\"\u003E&quot;raspberry pi&quot;\u003C\/span\u003E, \u003Cspan class=\"cm-property\"\u003Ecost\u003C\/span\u003E: \u003Cspan class=\"cm-string\"\u003E&quot;$60&quot;\u003C\/span\u003E},\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":8,"lines_more":3,"preview_is_truncated":false,"channels":["C9JP5B0TX"],"groups":[],"ims":[],"comments_count":0};
...
<!-- slack-www-hhvm-0962961a77cdd8e8d / 2018-03-28 13:35:31 / ve3a5d087ec810ee6227c82918b4a9e506fa0c2bf / B:H -->
